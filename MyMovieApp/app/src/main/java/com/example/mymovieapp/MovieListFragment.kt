...
import com.example.mymovieapp.MovieListFragmentDirections.Companion.actionMovieListFragmentToMovieDetailFragment
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        recyclerView.adapter = MovieAdapter(movies) { selectedMovie ->
                            val action = actionMovieListFragmentToMovieDetailFragment(selectedMovie)
